...
func (l *lsdb) insertFake() {
	// Insert sample LSPs

	input := []byte{0x00, 0x64, 0x04, 0xaf, 0x44, 0x44, 0x44, 0x44,
		0x44, 0x44, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a,
		0xf2, 0x52, 0x03, 0x01, 0x04, 0x03, 0x49, 0x00,
		0x14, 0x81, 0x01, 0xcc, 0x89, 0x02, 0x52, 0x34,
		0x84, 0x04, 0x0a, 0x00, 0x14, 0x01, 0x80, 0x0c,
		0x0a, 0x80, 0x80, 0x80, 0x0a, 0x00, 0x00, 0x00,
		0xff, 0xff, 0xff, 0xfc, 0x02, 0x0c, 0x00, 0x0a,
		0x80, 0x80, 0x80, 0x44, 0x44, 0x44, 0x44, 0x44,
		0x44, 0x01, 0x80, 0x18, 0x0a, 0x80, 0x80, 0x80,
		0x0a, 0x00, 0x14, 0x00, 0xff, 0xff, 0xff, 0xfc,
		0x14, 0x80, 0x80, 0x80, 0xc0, 0xa8, 0x14, 0x00,
		0xff, 0xff, 0xff, 0x00}

	input2 := bytes.NewBuffer(input)
	b, _ := packet.DecodeLSPDU(input2)

	lsdbEntry := newLSDBEntry(b)
	l.lsps[b.LSPID] = lsdbEntry
}
